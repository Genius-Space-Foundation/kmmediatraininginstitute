...
export const AssignmentDetails: React.FC = () => {
    ...
    useEffect(() => {
        const fetchAssignment = async () => {
            try {
                const assignments = await assignmentsApi.getAssignmentsForCourse(parseInt(courseId!));
    ...
    if (loading) {
        return <div className="flex justify-center py-8">Loading assignment details...</div>;
    }

    if (!assignment) {
        return <div className="text-center py-8 text-red-600">Assignment not found</div>;
    }
